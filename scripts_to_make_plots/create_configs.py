...
PATH = '/eos/atlas/atlascerngroupdisk/proj-simul/AF3_Run3/Jona/Simulate/GridOutputs/'
...
def create_config(version, option_dict):
  ...
  with open(output_file_name, 'w') as out_file:
    ...
    for counter, (input_case, input_version) in enumerate(option_dict['Inputs'].iteritems()):
      # Find input path and filename
      sim_case = {
        'FCS_Standard': 'Standard/',
        'FCS_PredictExtrapWeights': 'PredictExtrapWeights/',
    ...
    out_file.write("OutputPATH = '/eos/atlas/atlascerngroupdisk/proj-simul/AF3_Run3/Jona/CompareSimulations21_outputs/'\n")
...
if __name__ == '__main__':
  initial_counter = 140  # will start w/ JonaV{initial_counter}
  options = [
    {
      'Particle': 'pion',
      'Energy': '65536',
      'EtaBin': 'eta_20_25',
      'Inputs': {
                  'FCS_Standard': '18042022',
                  'FCGan_Standard': '18042022',
                  'FCGan_PredictExtrapWeights': '06052022_v2',
                },
    },
    #{
    #  'Particle': 'pion',
    ...
    #  'Inputs': {
    #              'FCS_Standard': '18042022',
    #              'FCS_PredictExtrapWeights': '24042022_v34',
    #            },
    #},
    #{
    #  'Particle': 'pion',
    ...
    #              'FCS_Standard': '18042022',
    #              'FCGan_Standard': '18042022',
    #              'FCGan_PredictExtrapWeights': '24042022_v34',
    #            },
    #},
    #{
    #  'Particle': 'pion',
    ...
    #  'Inputs': {
    #              'FCS_Standard': '18042022',
    #              'FCS_PredictExtrapWeights': '24042022_v35',
    #            },
    #},
    #{
    #  'Particle': 'pion',
    ...
    #              'FCS_Standard': '18042022',
    #              'FCGan_Standard': '18042022',
    #              'FCGan_PredictExtrapWeights': '24042022_v35',
    #            },
    #},
    #{
    #  'Particle': 'pion',
    ...
    #  'Inputs': {
    #              'FCS_Standard': '18042022',
    #              'FCS_PredictExtrapWeights': '24042022_v36',
    #            },
    #},
    #{
    #  'Particle': 'pion',
    ...
    #              'FCS_Standard': '18042022',
    #              'FCGan_Standard': '18042022',
    #              'FCGan_PredictExtrapWeights': '24042022_v36',
    #            },
    #},
  ]
